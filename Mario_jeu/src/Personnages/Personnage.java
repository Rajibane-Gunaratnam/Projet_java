//**************************Class Personnage*****************************************************************************
//	- Cette super class va permettre de créer des sous classe qui hériteros des données de cette class.
//
//*********************************************************************************************************************
//**************************IMPORT*************************************************************************************
package Personnages;
...
//*************************DECLARATION DES VARIABLES*******************************************************************
	...
	public int compteur;		//		compteur des pas des pas du personnage
	protected boolean vivant; // Personnage mario est vivant
...
//*************************METHODES************************************************************************************
	...
	public void deplacement() {
			if (FenetreJeu.niveau_1.getxPos() >= 0) {this.x = this.x - FenetreJeu.niveau_1.getDx();}
		}	
